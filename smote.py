...
class Smote:
    ...
    def minority_samples(self):
        return self.data[self.data['Adaptivity Level_High'] == 1]

    def smote(self):
        features = self.minority_samples.drop(['Adaptivity Level_High', 'Adaptivity Level_Low', 'Adaptivity Level_Moderate'], axis=1)
